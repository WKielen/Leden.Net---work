...
namespace Leden.Net
{
    ...
    [Serializable]
    [XmlType("Lid")]
    public class tblLid : Attribute//, ICloneable
    {
        #region Constants
		...
		/// <summary>Ge t or Set Medisch value</summary>
        [Category(A)]
        ...
        /// <summary>Get or Set VrijwillgersTaakUitgevoerd</summary>
        [Category(Overig)]
        public bool Extra3
        {
            get { return _Extra3; }
        ...
        public string CreateInsertString()
        {
            ...
            sb.Append("&VastBedrag=" + _VastBedrag);
            sb.Append("&Korting=" + _Korting);
    ...
    public class MySQLLidResponse
    {
        ...
        //public List<tblLid> posts { get; set; }
        public LedenLijst leden { get; set; }
    }
