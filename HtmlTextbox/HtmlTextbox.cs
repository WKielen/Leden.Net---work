    ...
    public partial class HtmlTextbox : UserControl {
        ...
        public string PlainText {
            get
            {
                ...
                return StringUtil.StripHTML(this.SourceText);
        ...
        private ToolbarStyles _toolbarStyle = ToolbarStyles.Internal;
        [DefaultValue(ToolbarStyles.Internal)]
        [Category("Appearance")]
        ...
        private void tsbColor_Click(object sender, EventArgs e) {
            ...
            {
               this.theBrowser.Document.ExecCommand("ForeColor", false, ColorTranslator.ToHtml(colorDialog.Color).ToString());
            }
        }
